"""
MediCore AI — Eye Diabetic Retinopathy CNN Trainer
...
DATA_DIR   = BASE_DIR / "cnn" / "eye" / "colored_images"
MODEL_DIR  = BASE_DIR / "cnn"
MODEL_PATH = MODEL_DIR / "eye_resnet50.pth"
META_PATH  = MODEL_DIR / "eye_meta.json"
...
def get_class_weights(train_loader, num_classes):
    ...
    total = counts.sum()
    return (total / (num_classes * counts)).to(DEVICE)
